...
def build_evidence_bundle(project_root: Path, output: Path) -> dict:
    ...
    payload = {
        ...
        "blocking_evidence": [
            ...
            "a validated ROI adapter: the training-free adapter failed prospectively; a post-failure learned adapter improved segmentation but failed six of nine development gates and still requires redesign plus independent-acquisition confirmation",
