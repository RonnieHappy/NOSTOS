"""Execute and repeat the frozen physical-truth v2.2 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_2 import (
    build_synthetic_physical_truth_v2_2,
)


ROOT = Path(__file__).resolve().parents[1]
PRIMARY = ROOT / "outputs/nostos0-synthetic-physical-truth-v2-2-confirmation/validation.json"
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_2(ROOT)
    second = build_synthetic_physical_truth_v2_2(ROOT)
