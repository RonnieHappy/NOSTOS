"""Execute and repeat the frozen synthetic physical-truth v2.1 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_1 import (
    build_synthetic_physical_truth_v2_1,
)


ROOT = Path(__file__).resolve().parents[1]
PRIMARY = ROOT / "outputs/nostos0-synthetic-physical-truth-v2-1-confirmation/validation.json"
REPEAT = ROOT / "outputs/nostos0-synthetic-physical-truth-v2-1-confirmation-repeat/validation.json"
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_1(ROOT)
    second = build_synthetic_physical_truth_v2_1(ROOT)
