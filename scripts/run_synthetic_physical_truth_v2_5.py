"""Execute and repeat the frozen physical-truth v2.5 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_5 import (
    build_synthetic_physical_truth_v2_5,
)
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_5(ROOT)
    second = build_synthetic_physical_truth_v2_5(ROOT)
