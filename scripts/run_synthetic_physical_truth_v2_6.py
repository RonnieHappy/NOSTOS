"""Execute and repeat the frozen physical-truth v2.6 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_6 import (
    build_synthetic_physical_truth_v2_6,
)
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_6(ROOT)
    second = build_synthetic_physical_truth_v2_6(ROOT)
