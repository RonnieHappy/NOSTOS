"""Execute and repeat the frozen physical-truth v2.3 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_3 import (
    build_synthetic_physical_truth_v2_3,
)


ROOT = Path(__file__).resolve().parents[1]
PRIMARY = ROOT / "outputs/nostos0-synthetic-physical-truth-v2-3-confirmation/validation.json"
REPEAT = ROOT / "outputs/nostos0-synthetic-physical-truth-v2-3-confirmation-repeat/validation.json"
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_3(ROOT)
    second = build_synthetic_physical_truth_v2_3(ROOT)
