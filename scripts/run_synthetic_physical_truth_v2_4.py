"""Execute and repeat the frozen physical-truth v2.4 confirmation."""
...
from nostos.validation.synthetic_physical_truth_v2_4 import (
    build_synthetic_physical_truth_v2_4,
)
...
def main() -> None:
    first = build_synthetic_physical_truth_v2_4(ROOT)
    second = build_synthetic_physical_truth_v2_4(ROOT)
