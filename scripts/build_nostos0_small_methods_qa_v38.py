"""Build machine-readable production QA receipts for Small Methods v38."""
...
def main() -> None:
    ...
    build_one(
        ...
        docx=ROOT / "manuscripts" / "NOSTOS_Small_Methods_submission_ready_v38.docx",
        render_dir=ROOT / "manuscripts" / "NOSTOS_Small_Methods_v38_visual_qa",
        pdf=ROOT / "manuscripts" / "NOSTOS_Small_Methods_v38_visual_qa" / "NOSTOS_Small_Methods_submission_ready_v38.pdf",
        output=AUDITS / "nostos_small_methods_v38_manuscript_qa.json",
        pages=13,
        media=8,
        required_text=MAIN_REQUIRED,
    )
    build_one(
        source=ROOT / "scripts" / "build_nostos0_small_methods_si_v38.py",
        docx=ROOT / "manuscripts" / "NOSTOS_Small_Methods_Supporting_Information_v38.docx",
        render_dir=ROOT / "manuscripts" / "NOSTOS_Small_Methods_SI_v38_visual_qa",
        pdf=ROOT / "manuscripts" / "NOSTOS_Small_Methods_SI_v38_visual_qa" / "NOSTOS_Small_Methods_Supporting_Information_v38.pdf",
        output=AUDITS / "nostos_small_methods_v38_si_qa.json",
        pages=5,
        media=4,
        required_text=SI_REQUIRED,
    )
    print("v38 manuscript and Supporting Information production QA: pass")
