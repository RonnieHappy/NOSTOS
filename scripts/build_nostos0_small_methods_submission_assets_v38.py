"""Export the final v38 Small Methods artwork as 600 dpi LZW TIFF files."""
...
FIG = ROOT / "figures" / "nostos0_small_methods_v38"
OUT = ROOT / "manuscripts" / "Small_Methods_v38_submission_assets" / "figures"
...
def main() -> None:
    ...
    payload = {"schema": "nostos.small-methods.artwork.v38", "files": records}
